...
import yaml
import json
from discourse_comments import discourse_comments
...
def setup(app):
    ...
    app.add_node(discourse_comments.DiscourseCommentsNode, html=(discourse_comments.DiscourseCommentsNode.visit, discourse_comments.DiscourseCommentsNode.depart))
    app.add_directive('discourse_comments', discourse_comments.DiscourseCommentsDirective)
